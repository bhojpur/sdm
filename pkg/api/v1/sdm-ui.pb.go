...
func (x *ListDeviceSpecsRequest) Reset() {
	*x = ListDeviceSpecsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sdm_ui_proto_msgTypes[0]
...
func (*ListDeviceSpecsRequest) Descriptor() ([]byte, []int) {
	return file_sdm_ui_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListDeviceSpecsResponse) Reset() {
	*x = ListDeviceSpecsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sdm_ui_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListDeviceSpecsResponse) Descriptor() ([]byte, []int) {
	return file_sdm_ui_proto_rawDescGZIP(), []int{1}
}
...
// DesiredAnnotation describes an annotation a Storage Device should have
...
func (x *DesiredAnnotation) Reset() {
	*x = DesiredAnnotation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sdm_ui_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DesiredAnnotation) Descriptor() ([]byte, []int) {
	return file_sdm_ui_proto_rawDescGZIP(), []int{2}
}
...
func (x *IsReadOnlyRequest) Reset() {
	*x = IsReadOnlyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sdm_ui_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IsReadOnlyRequest) Descriptor() ([]byte, []int) {
	return file_sdm_ui_proto_rawDescGZIP(), []int{3}
}
...
func (x *IsReadOnlyResponse) Reset() {
	*x = IsReadOnlyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sdm_ui_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IsReadOnlyResponse) Descriptor() ([]byte, []int) {
	return file_sdm_ui_proto_rawDescGZIP(), []int{4}
}
...
var File_sdm_ui_proto protoreflect.FileDescriptor

var file_sdm_ui_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x73, 0x64, 0x6d, 0x2d, 0x75, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02,
	0x76, 0x31, 0x1a, 0x09, 0x73, 0x64, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x18, 0x0a,
	...
	0x70, 0x75, 0x72, 0x2f, 0x73, 0x64, 0x6d, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_sdm_ui_proto_rawDescOnce sync.Once
	file_sdm_ui_proto_rawDescData = file_sdm_ui_proto_rawDesc
)

func file_sdm_ui_proto_rawDescGZIP() []byte {
	file_sdm_ui_proto_rawDescOnce.Do(func() {
		file_sdm_ui_proto_rawDescData = protoimpl.X.CompressGZIP(file_sdm_ui_proto_rawDescData)
	})
	return file_sdm_ui_proto_rawDescData
}

var file_sdm_ui_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_sdm_ui_proto_goTypes = []interface{}{
...
var file_sdm_ui_proto_depIdxs = []int32{
...
func init() { file_sdm_ui_proto_init() }
func file_sdm_ui_proto_init() {
	if File_sdm_ui_proto != nil {
		return
	}
	file_sdm_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_sdm_ui_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sdm_ui_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sdm_ui_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sdm_ui_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sdm_ui_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sdm_ui_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_sdm_ui_proto_goTypes,
		DependencyIndexes: file_sdm_ui_proto_depIdxs,
		MessageInfos:      file_sdm_ui_proto_msgTypes,
	}.Build()
	File_sdm_ui_proto = out.File
	file_sdm_ui_proto_rawDesc = nil
	file_sdm_ui_proto_goTypes = nil
	file_sdm_ui_proto_depIdxs = nil
}
